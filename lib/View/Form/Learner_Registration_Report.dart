...
class LearnerRegistrationReport extends StatefulWidget {
  const LearnerRegistrationReport({Key? key}) : super(key: key);

  @override
  State<LearnerRegistrationReport> createState() =>
      _LearnerRegistrationReportState();
}

class _LearnerRegistrationReportState extends State<LearnerRegistrationReport> {
            ...
            return Scaffold(
                appBar: AppBar(
                  ...
                  actions: [
                    IconButton(
                        onPressed: () {
                          Get.toNamed(ROUTE_LEARNERREGISTRATIONSEARCH);
                        },
